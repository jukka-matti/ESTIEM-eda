...
from .visualization_response import ArtifactData, ChartData, FormatContent, VisualizationFormat
...
class ArtifactGenerator(BaseFormatGenerator):
    ...
    def generate_react(self, chart_data: ChartData, **kwargs) -> FormatContent:
        ...
        """
        component_name = kwargs.get(
            "component_name", f"{chart_data.chart_type.title().replace('_', '')}Chart"
        )
...
export default {component_name};"""
    ...
    def generate(
        self, chart_data: ChartData, artifact_type: str = "react", **kwargs
    ) -> FormatContent:
...
class TextFallbackGenerator(BaseFormatGenerator):
    ...
    def generate(
        self, chart_data: ChartData, analysis_results: dict | None = None, **kwargs
    ) -> FormatContent:
        ...
        """
        chart_data.chart_type.replace("_", " ").title()
...
Generated by ESTIEM EDA Toolkit - ANOVA Analysis"""
    ...
    def _generate_pareto_text(self, chart_data: ChartData, results: dict) -> str:
        ...
        pareto_table = []
        for i, (cat, pct) in enumerate(zip(categories, percentages, strict=False)):
...
class MultiFormatGenerator:
    ...
    def generate_all_formats(
        ...
        formats: list[VisualizationFormat] | None = None,
    ) -> dict[VisualizationFormat, FormatContent]:
