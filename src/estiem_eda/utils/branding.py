    ...
    try:
        ...
        fig.add_layout_image(
            dict(
                ...
                x=0.98, y=0.02,  # Bottom-right corner
        ...
        fig.add_annotation(
            ...
            xanchor="right", yanchor="bottom",
            showarrow=False,
            font=dict(size=10, color="#2E8B57", family="Arial", weight="bold"),
            opacity=opacity
        )
...
def add_estiem_footer(fig: go.Figure, 
                     analysis_type: str,
    ...
    fig.add_annotation(
        ...
        showarrow=False,
        font=dict(size=9, color="#666666", family="Arial"),
        opacity=0.8
    )
