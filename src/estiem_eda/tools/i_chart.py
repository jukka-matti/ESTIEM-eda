...
class IChartTool(SimplifiedMCPTool):
    ...
    def __init__(self):
        ...
        super().__init__(
            name="i_chart", description="Individual control chart for process monitoring and SPC"
        )
        ...
        return {
            ...
            "properties": {
                ...
                "specification_limits": {
                    "type": "object",
                    "properties": {"lsl": {"type": "number"}, "usl": {"type": "number"}},
    ...
    def create_interpretation(self, stats: dict[str, Any], **kwargs) -> str:
        ...
        return (
            f"Process {stability} with a mean of {mean:.4f}. "
